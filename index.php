...
if (isset($_POST['signup'])) {
    ...
    // E-mail or Mobile Manage:
    $email = '';
    $mobile = '';
    if (filter_var($moe, FILTER_VALIDATE_EMAIL)) {
        $email = $moe;
    }else{
        $mobile = $moe;
    }
    ...
    // Main Validation:
    if (empty($name) || empty($moe) || empty($pass) || empty($dob) || empty($gender)) {
        
        $notice = valid('Fill the Required Fields');
    }else{
        insert("INSERT INTO users (name, email, mobile, password, dob, gender, photo) VALUES ('$name', '$email', '$mobile', '$hash_pass', '$dob', '$gender', '')");

        $notice = valid('Registration Successful', 'success');
    }
...
?>
	...
	<div class="mx-auto w-50" style="position: absolute; top:50px; left:0px; right:0px;">

     <?php include "templates/notice.php"; ?>  </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" placeholder="Mobile number or Email Address" name="moe">
                        </div>
                        <div class="form-group">
